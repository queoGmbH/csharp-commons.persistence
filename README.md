...
- If you want to use the TransactionHandling, you have to call the method "UseTransactionHandling <TDbContext>(this IServiceCollection services)" from the TransactionHandlingExtensions class inside your program.cd or startup.cs.